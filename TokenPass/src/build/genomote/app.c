...
typedef TMilli TokenRingC$TimerWorker$precision_tag;
enum /*HilTimerMilliC.AlarmMilli32C.AlarmFrom.Msp430Timer*/Msp430Timer32khzC$0$__nesc_unnamed4289 {
...
static void TokenRingC$AMControl$startDone(error_t error);
#line 117
static void TokenRingC$AMControl$stopDone(error_t error);
# 49 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Boot.nc"
static void TokenRingC$Boot$booted(void );
# 99 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
static void TokenRingC$AMSend$sendDone(
#line 92
message_t * msg, 
...
static void TokenRingC$TimerWorker$fired(void );
...
static error_t /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(
#line 121
message_t * msg, 
...
static void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 85
message_t * msg, 
...
# 38 "/home/comp4300/local/src/tinyos-2.x/tos/system/AMQueueImplP.nc"
uint8_t arg_0x4097fca0, 
# 111 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Send.nc"
message_t * msg, 
...
# 39 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/CC2420ActiveMessageP.nc"
am_id_t arg_0x409c5088, 
# 121 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
message_t * msg, 
...
uint8_t len);
# 83 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t TokenRingC$AMControl$start(void );
# 69 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t TokenRingC$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 61 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Leds.nc"
static void TokenRingC$Leds$led1On(void );




static void TokenRingC$Leds$led1Off(void );
#line 83
static void TokenRingC$Leds$led2Off(void );
#line 45
static void TokenRingC$Leds$led0On(void );
# 62 "/home/comp4300/local/src/tinyos-2.x/tos/lib/timer/Timer.nc"
static void TokenRingC$TimerWorker$startOneShot(uint32_t dt);
# 19 "TokenRingC.nc"
bool TokenRingC$sending;
bool TokenRingC$holdToken;

const uint8_t TokenRingC$NODE_QUANTITY = 3;

enum TokenRingC$__nesc_unnamed4299 {
  TokenRingC$TIMER_PERIOD_MILLI = 250, 

  TokenRingC$ACCEL_INTERVAL = 256, 
  TokenRingC$ACCEL_PERIOD = 10000, 
  TokenRingC$ACCEL_NSAMPLES = 10, 
  TokenRingC$ACCEL_VARIANCE = 4
};


static inline void TokenRingC$Led0On(void );
static inline void TokenRingC$Led1On(void );


static inline void TokenRingC$Led1Off(void );
static inline void TokenRingC$Led2Off(void );
static void TokenRingC$passToken(void );

static inline void TokenRingC$Boot$booted(void );
#line 56
static inline void TokenRingC$AMControl$startDone(error_t error);
#line 84
static inline void TokenRingC$AMControl$stopDone(error_t error);




static inline void TokenRingC$AMSend$sendDone(message_t *msg, error_t error);
#line 103
static inline void TokenRingC$TimerWorker$fired(void );




static inline message_t *TokenRingC$Receive$receive(message_t *msg, void *payload, 
uint8_t len);
#line 131
static inline void TokenRingC$Led0On(void );
...
# 99 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 56
message_t * msg, 
...
/*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(
#line 111
message_t * msg, 
...
static void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 147
message_t * amsg, 
...
static inline error_t /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
...
static inline void */*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(message_t *m, uint8_t len);
# 69 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
...
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4308 {
#line 118
...
#line 161
enum /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4309 {
#line 161
...
#line 49
#line 47
typedef struct /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$__nesc_unnamed4310 {
  message_t * msg;
...
#line 58
enum CC2420CsmaP$__nesc_unnamed4314 {
...
enum CC2420ControlP$__nesc_unnamed4316 {
#line 118
...
#line 85
#line 79
typedef enum CC2420ControlP$__nesc_unnamed4317 {
...
enum /*Counter32khz32C.Transform*/TransformCounterC$1$__nesc_unnamed4318 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC$1$__nesc_unnamed4319 {
...
enum CC2420SpiP$__nesc_unnamed4322 {
  CC2420SpiP$S_IDLE, 
  CC2420SpiP$S_BUSY
};
...
enum StateImplP$__nesc_unnamed4323 {
  StateImplP$S_IDLE = 0
};
...
#line 67
  Msp430SpiNoDmaP$0$signalDone_task = 10U
};
#line 67
...
enum /*Msp430UsartShare0P.ArbiterC.Queue*/FcfsResourceQueueC$0$__nesc_unnamed4326 {
#line 39
...
#line 69
enum /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$__nesc_unnamed4330 {
#line 69
...
#line 80
typedef enum CC2420TransmitP$__nesc_unnamed4331 {
...
enum CC2420TransmitP$__nesc_unnamed4332 {
...
enum CC2420ReceiveP$__nesc_unnamed4335 {
...
# 28 "/home/comp4300/local/src/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$fired(uint8_t arg_0x4068b428){
#line 28
  switch (arg_0x4068b428) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$default$fired(arg_0x4068b428);
#line 28
      break;
#line 28
    }
...
# 55 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x40d47b38){
#line 55
  switch (arg_0x40d47b38) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x40d47b38);
#line 55
      break;
#line 55
    }
...
# 110 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$release(uint8_t arg_0x40c6c610){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x40c6c610) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$release(arg_0x40c6c610);
#line 110
      break;
#line 110
    }
...
# 88 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCongestionBackoff(am_id_t arg_0x409e4148, message_t * msg){
#line 88
    CC2420ActiveMessageP$RadioBackoff$default$requestCongestionBackoff(arg_0x409e4148, msg);
#line 88
}
#line 88
...
# 118 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$isOwner(uint8_t arg_0x40c6c610){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$isOwner(arg_0x40c6c610);
#line 118
      break;
#line 118
    }
...
# 39 "/home/comp4300/local/src/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$getConfig(uint8_t arg_0x40c6b088){
#line 39
  union __nesc_unnamed4280 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$default$getConfig(arg_0x40c6b088);
#line 39
...
# 49 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x40d47b38){
#line 49
  switch (arg_0x40d47b38) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$configure(arg_0x40d47b38);
#line 49
      break;
#line 49
    }
...
# 51 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$immediateRequested(uint8_t arg_0x40d48770){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$immediateRequested(arg_0x40d48770);
#line 51
}
#line 51
...
# 87 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$immediateRequest(uint8_t arg_0x40c6c610){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$immediateRequest(arg_0x40c6c610);
#line 87
      break;
#line 87
    }
...
# 43 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$requested(uint8_t arg_0x40d48770){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$requested(arg_0x40d48770);
#line 43
}
#line 43
...
# 78 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$request(uint8_t arg_0x40c6c610){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$request(arg_0x40c6c610);
#line 78
      break;
#line 78
    }
...
#line 54
# 240 "/home/comp4300/local/lib/ncc/nesc_nx.h"
static __inline  uint8_t __nesc_hton_uint8(void * target, uint8_t value)
#line 240
{
  uint8_t *base = target;
...
# 67 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420TinyosNetworkP$NonTinyosReceive$receive(uint8_t arg_0x40fadb78, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420TinyosNetworkP$NonTinyosReceive$default$receive(arg_0x40fadb78, msg, payload, len);
#line 67
...
# 67 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Snoop$receive(am_id_t arg_0x409e6108, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP$Snoop$default$receive(arg_0x409e6108, msg, payload, len);
#line 67
...
# 62 "/home/comp4300/local/src/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void TokenRingC$TimerWorker$startOneShot(uint32_t dt){
#line 62
...
# 61 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void TokenRingC$Leds$led1On(void ){
#line 61
  LedsP$Leds$led1On();
#line 61
}
...
#line 114
      if (__nesc_ntoh_uint16(data->opcode.data) == 0 && __nesc_ntoh_uint16(data->length.data) == 0) {


          TokenRingC$holdToken = TRUE;


          TokenRingC$Led1On();

          TokenRingC$TimerWorker$startOneShot(2000);
        }
    }
...
# 67 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Receive$receive(am_id_t arg_0x409c5a48, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x409c5a48) {
#line 67
    case 0:
#line 67
      __nesc_result = TokenRingC$Receive$receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP$Receive$default$receive(arg_0x409c5a48, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$granted(uint8_t arg_0x40c728d0){
#line 92
  switch (arg_0x40c728d0) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$default$granted(arg_0x40c728d0);
#line 92
      break;
#line 92
    }
...
# 92 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$granted(uint8_t arg_0x40d49ce8){
#line 92
  switch (arg_0x40d49ce8) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$default$granted(arg_0x40d49ce8);
#line 92
      break;
#line 92
    }
...
# 71 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$sendDone(uint8_t arg_0x40c6de08, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40c6de08) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$default$sendDone(arg_0x40c6de08, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$readDone(uint8_t arg_0x40bd2178, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x40bd2178) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP$Fifo$default$readDone(arg_0x40bd2178, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestInitialBackoff(am_id_t arg_0x409e4148, message_t * msg){
#line 81
    CC2420ActiveMessageP$RadioBackoff$default$requestInitialBackoff(arg_0x409e4148, msg);
#line 81
}
#line 81
...
# 91 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$writeDone(uint8_t arg_0x40bd2178, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x40bd2178) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP$Fifo$default$writeDone(arg_0x40bd2178, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP$Resource$granted(uint8_t arg_0x40bd3730){
#line 92
  switch (arg_0x40bd3730) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP$Resource$default$granted(arg_0x40bd3730);
#line 92
      break;
#line 92
    }
...
inline static void TokenRingC$Leds$led1Off(void ){
#line 66
  LedsP$Leds$led1Off();
#line 66
}
...
#line 95
    {
      ...
      TokenRingC$passToken();
    }
}

# 99 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  TokenRingC$AMSend$sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 89 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x4097fca0, message_t * msg, error_t error){
#line 89
  switch (arg_0x4097fca0) {
#line 89
    case 0U:
#line 89
      /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x4097fca0, msg, error);
#line 89
      break;
#line 89
    }
...
# 99 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP$AMSend$sendDone(am_id_t arg_0x409c5088, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x409c5088, msg, error);
#line 99
}
#line 99
...
#line 66
# 237 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static inline void CC2420CsmaP$sendDone_task$runTask(void )
#line 237
{
  error_t packetErr;
...
# 59 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP$SendNotifier$aboutToSend(am_id_t arg_0x409e5aa0, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP$SendNotifier$default$aboutToSend(arg_0x409e5aa0, dest, msg);
#line 59
}
#line 59
...
# 95 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCca(am_id_t arg_0x409e4148, message_t * msg){
#line 95
    CC2420ActiveMessageP$RadioBackoff$default$requestCca(arg_0x409e4148, msg);
#line 95
}
#line 95
...
# 124 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$getPayload(am_id_t arg_0x4097c730, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = CC2420ActiveMessageP$AMSend$getPayload(arg_0x4097c730, msg, len);
#line 124
...
#line 124
# 203 "/home/comp4300/local/src/tinyos-2.x/tos/system/AMQueueImplP.nc"
static inline void */*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$getPayload(uint8_t id, message_t *m, uint8_t len)
#line 203
{
...
# 114 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Send.nc"
inline static void * /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 114
# 65 "/home/comp4300/local/src/tinyos-2.x/tos/system/AMQueueEntryP.nc"
static inline void */*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(message_t *m, uint8_t len)
#line 65
{
  return /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(m, len);
}

# 124 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * TokenRingC$AMSend$getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(msg, len);
#line 124
...
#line 124
#line 69
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x4097c730, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP$AMSend$send(arg_0x4097c730, addr, msg, len);
#line 69
...
# 64 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
inline static void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
# 92 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 47
{
  /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 0);
  return /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 69 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t TokenRingC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*TokenRingAppC.AMSender.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 69
...
#line 117
  TokenRingC$AMControl$stopDone(error);
#line 117
}
#line 117
...
# 83 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t TokenRingC$AMControl$start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 92
  TokenRingC$AMControl$startDone(error);
#line 92
}
#line 92
# 110 "/home/comp4300/local/src/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 72 "/home/comp4300/local/src/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x409239f0){
#line 72
  switch (arg_0x409239f0) {
#line 72
    case 0U:
#line 72
      TokenRingC$TimerWorker$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x409239f0);
#line 72
      break;
#line 72
    }
...
inline static void TokenRingC$Leds$led2Off(void ){
#line 83
  LedsP$Leds$led2Off();
#line 83
}
...
inline static void TokenRingC$Leds$led0On(void ){
#line 45
  LedsP$Leds$led0On();
#line 45
}
...
# 54 "/home/comp4300/local/src/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$rxDone(uint8_t arg_0x40d3e5a8, uint8_t data){
#line 54
  switch (arg_0x40d3e5a8) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$rxDone(arg_0x40d3e5a8, data);
#line 54
      break;
#line 54
    }
...
# 39 "/home/comp4300/local/src/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$fired(uint8_t arg_0x40d3ee28){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$default$fired(arg_0x40d3ee28);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$txDone(uint8_t arg_0x40d3e5a8){
#line 49
  switch (arg_0x40d3e5a8) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$txDone(arg_0x40d3e5a8);
#line 49
      break;
#line 49
    }
...
# 28 "/home/comp4300/local/src/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$fired(uint8_t arg_0x4068b428){
#line 28
  switch (arg_0x4068b428) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$default$fired(arg_0x4068b428);
#line 28
      break;
#line 28
    }
...
# 329 "/home/comp4300/local/src/tinyos-2.x/tos/chips/cc2420/spi/CC2420SpiP.nc"
static void CC2420SpiP$SpiPacket$sendDone(uint8_t *tx_buf, uint8_t *rx_buf, 
uint16_t len, error_t error)
#line 330
{
...
#line 56
# 166 "/home/comp4300/local/src/tinyos-2.x/tos/system/AMQueueImplP.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$tryToSend(void )
#line 166
{
...
#line 157
{
  ...
  payload = TokenRingC$AMSend$getPayload(&msg, sizeof(data_t ));

  next = (uint8_t )((TOS_NODE_ID + 1) % TokenRingC$NODE_QUANTITY);

  if (payload && !TokenRingC$sending) {
      __nesc_hton_uint16(payload->opcode.data, 0);
      __nesc_hton_uint16(payload->length.data, 0);

      if (TokenRingC$AMSend$send(next, &msg, sizeof(data_t )) == SUCCESS) {
          TokenRingC$sending = TRUE;
        }
    }
}
